        ...
        if st.button("Submit & Process"):
            if pdf_docs:
                with st.spinner("Processing..."):
                    ...
                    st.success("PDF files have been successfully processed!")
            else:
    ...
    if not st.session_state.submitted:
        st.markdown("""
            <div class="instructions">
                ...
                <h5>1. Upload your PDF files using the sidebar menu.</h5>
                <h5>2. Click on "Submit & Process" to analyze the files.</h5>
                <h5>3. Ask any question related to the content of the PDF files.</h5>
            </div>
        """, unsafe_allow_html=True)
